...
const Dashboard = () => {
  ...
  const initChart = async () => {
    ...
    if (dashboardData.isAdminUser) {
      await dashboardData.loadSuccessRateData();
    }
  };
  ...
  // ========== Effects ==========
  React.useEffect(() => {
    if (dashboardData.successRateData && dashboardData.successRateData.length > 0) {
      dashboardCharts.updateSuccessRateChart(dashboardData.successRateData);
    }
  }, [dashboardData.successRateData]);
      ...
      <div className='mb-4'>
        ...
        >
          <ChartsPanel
            ...
            spec_success_rate={dashboardCharts.spec_success_rate}
            isAdminUser={dashboardData.isAdminUser}
            CARD_PROPS={CARD_PROPS}
            CHART_CONFIG={CHART_CONFIG}
