...
var defaultModelRatio = map[string]float64{
	...
	"gpt-5-pro":                        10.0, // 参考 o3-pro 定价
	"gpt-4o-image":                     2.5,  // 参考 gpt-image-1
...
var defaultModelPrice = map[string]float64{
	...
	"doubao-seedream-5-0-260128":      0.6,
	...
	// Gemini image preview — per-route pricing (100 credits = $1)
	// 普通(apimart) / 尊享(vip) / 极速(ultra)
	"gemini-3-pro-image-preview":             0.4,
	"gemini-3-pro-image-preview-apimart":     0.8,
	"gemini-3-pro-image-preview-vip":         0.9,
	"gemini-3-pro-image-preview-ultra":       1.79,
	"gemini-3.1-flash-image-preview":         0.3,
	"gemini-3.1-flash-image-preview-apimart": 0.5,
	"gemini-3.1-flash-image-preview-vip":     0.4,
	"gemini-3.1-flash-image-preview-ultra":   1.13,
	"gemini-2.5-flash-image-preview":         0.2,
	"gemini-2.5-flash-image-preview-apimart": 0.2,
	"gemini-2.5-flash-image-preview-vip":     0.4,
	// GPT Image 2 — per-channel / per-quality pricing
	"gpt-image-2":                0.4,
	"gpt-image-2-apimart":        0.4,
	"gpt-image-2-rightcodes":     0.4,
