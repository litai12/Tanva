...
func VeoResolutionRatio(modelName, resolution string) float64 {
	...
	// 4K multipliers based on current APIMart pricing:
	//   veo-3.1-generate:      1.5 (from Vertex AI $0.60/$0.40)
	//   veo-3.1-fast-generate: 2.333 (from Vertex AI $0.40 fast vs $0.60 standard, scaled)
