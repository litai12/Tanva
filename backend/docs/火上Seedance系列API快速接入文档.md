...
:::tip
请确保您的账户余额大于等于 200 元（[前往充值](https://console.volcengine.com/finance/fund/recharge)），或已[购买资源包](https://console.volcengine.com/common-buy/fast/ark_bd%7C%7Cd682ppeeq1mp7kd5q0e0)，否则无法开通 Seedance 2.0 系列模型。
:::
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Windows 用户" key="mjLrYbyGq8"><RenderMd content={`1. 进入 \`scripts/init_dev_env\` 目录。
...
<Tabs.TabPane title="macOS 用户" key="qK5tF28bxy"><RenderMd content={`1. 打开终端，进入 \`scripts/init_dev_env\` 目录。
2. 运行构建脚本：
...
|[返回视频产物对应的尾帧图](https://www.volcengine.com/docs/82379/2298881?lang=zh#141cf7fa)| |<span>![图片](https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/ee51ce32c1914aed81ff95080bb7db1d~tplv-goo7wpa0wc-image.image =20x) </span> |<span>![图片](https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/ee51ce32c1914aed81ff95080bb7db1d~tplv-goo7wpa0wc-image.image =20x) </span> |\
|> "return_last_frame":| | | |\
|> "true" | | | |
|[输出视频规格](https://www.volcengine.com/docs/82379/2298881?lang=zh#9fe4cce0) |输出分辨率|480p, 720p, 1080p |480p, 720p |\
| |> "resolution": "720p" | | |
| |输出宽高比|21:9, 16:9, 4:3,|21:9, 16:9, 4:3,|\
| |> "ratio":"16:9" |1:1, 3:4, 9:16 |1:1, 3:4, 9:16 |
| |输出时长|4~15 秒 |4~15 秒 |\
| |> "duration": 5 | | |
| |输出视频格式 |mp4 |mp4 |
|[离线推理](https://www.volcengine.com/docs/82379/2298881?lang=zh#c3588bd1)| |<span>![图片](https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/f359753773c94d97885008ca1223c9bc~tplv-goo7wpa0wc-image.image =20x) </span> |<span>![图片](https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/f359753773c94d97885008ca1223c9bc~tplv-goo7wpa0wc-image.image =20x) </span> |\
|> "service_tier": "flex" | | | |
...
| || |\
| |<span>![图片](https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/37ef4b6af8944a6d9b54ef1c541c1b0e~tplv-goo7wpa0wc-image.image =280x) </span>| |\
| |<span>![图片](https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/7b904d6b46d24f059de7697620058b7f~tplv-goo7wpa0wc-image.image =280x) </span>| |\
| |<Attachment link="https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/8bbbacecfd7d48dfa7ec6ec74125eb04~tplv-goo7wpa0wc-image.image" name="r2v_tea_audio1.mp3">r2v_tea_audio1.mp3</Attachment>| |\
| | | |


```mixin-react
return (<Tabs>
<Tabs.TabPane title="Python" key="GAtJFGRqVj"><RenderMd content={`\`\`\`Python
import os
import time
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="RqQ7Q4YESn"><RenderMd content={`\`\`\`Java
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="wICxnfzqs4"><RenderMd content={`\`\`\`Go
package main
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Python" key="krLWC5ZfCz"><RenderMd content={`\`\`\`Python
import os
import time
# Install SDK:  pip install 'volcengine-python-sdk[ark]'
from volcenginesdkarkruntime import Ark 
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="oIUUhx69WF"><RenderMd content={`\`\`\`Java
package com.ark.sample;
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="P23UNc19zd"><RenderMd content={`\`\`\`Go
package main
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Python" key="vHfz5h5Aes"><RenderMd content={`\`\`\`Python
import os
import time
# Install SDK:  pip install 'volcengine-python-sdk[ark]'
from volcenginesdkarkruntime import Ark 
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="YpetS5nV45"><RenderMd content={`\`\`\`Java
package com.ark.sample;
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="GP6vzUktTz"><RenderMd content={`\`\`\`Go
package main
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Python" key="p08Z9lsEYq"><RenderMd content={`\`\`\`Python
import os
import time  
# Install SDK:  pip install 'volcengine-python-sdk[ark]'
from volcenginesdkarkruntime import Ark 
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="q605EaMmrA"><RenderMd content={`\`\`\`Java
package com.ark.sample;
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="WFlCwx1gCt"><RenderMd content={`\`\`\`Go
package main
...
|---|---|---|
|Seedance 2.0 及 Seedance 2.0 Fast 生成的含人脸视频 |2026年03月11日起 |30天 |
|Seedance 2.0 及 Seedance 2.0 Fast 生成的含人脸视频对应的尾帧图片 |2026年04月16日起 |30天 |
...
* 压缩或转发文件易引发信任失效，建议直接将模型原始产物转存至 TOS 使用。
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Python" key="pnbi87oTRz"><RenderMd content={`1. 首次生视频，并获取视频 URL。此处直接用[使用预置虚拟人像](/docs/82379/2291680#2bf01416)示例生成的视频。
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="TH1r0luJmD"><RenderMd content={`1. 首次生视频，并获取视频 URL。此处直接用[使用预置虚拟人像](/docs/82379/2291680#2bf01416)示例生成的视频。
2. 对 Seedance 2.0 生成的视频进行再次编辑。视频原始 URL 的有效期仅 24 小时，本示例将原始视频转存至 TOS 使用。
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="oX5h85kHWF"><RenderMd content={`1. 首次生视频，并获取视频 URL。此处直接用[使用预置虚拟人像](/docs/82379/2291680#2bf01416)示例生成的视频。
2. 对 Seedance 2.0 生成的视频进行再次编辑。视频原始 URL 的有效期仅 24 小时，本示例将原始视频转存至 TOS 使用。
...
:::tip
开通虚拟人像库，浏览及检索虚拟人像请参见[虚拟人像库](/docs/82379/2223965)。
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Python" key="w713TfLz1P"><RenderMd content={`\`\`\`Python
import os
import time
# Install SDK:  pip install 'volcengine-python-sdk[ark]'
from volcenginesdkarkruntime import Ark 
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="evDdDmkhMA"><RenderMd content={`\`\`\`Java
package com.ark.sample;
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="AS2fzt5s4c"><RenderMd content={`\`\`\`Go
package main
...
下文介绍多模态参考、编辑视频、延长视频的提示词典型公式，更多详细内容请参见[Doubao Seedance 2.0 系列提示词指南](/docs/82379/2222480)。
:::tip
...
<Attachment link="https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/747e193d440f4df6a72dd3683c3a865f~tplv-goo7wpa0wc-image.image" name="SKILL.md">SKILL.md</Attachment>
