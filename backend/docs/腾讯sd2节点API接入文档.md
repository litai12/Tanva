...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Windows 用户" key="Ez0PJKFQLL"><RenderMd content={`1. 进入 \`scripts/init_dev_env\` 目录。
...
<Tabs.TabPane title="macOS 用户" key="pH7uDCTCjE"><RenderMd content={`1. 打开终端，进入 \`scripts/init_dev_env\` 目录。
2. 运行构建脚本：
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Python" key="INcrrXl8Hv"><RenderMd content={`\`\`\`Python
import os
import time
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="RzZyw2JAsB"><RenderMd content={`\`\`\`Java
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="eNy6kkKG6Y"><RenderMd content={`\`\`\`Go
package main
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Python" key="iKAiOLptEM"><RenderMd content={`\`\`\`Python
import os
import time
# Install SDK:  pip install 'volcengine-python-sdk[ark]'
from volcenginesdkarkruntime import Ark 
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="TFvlTjC3Co"><RenderMd content={`\`\`\`Java
package com.ark.sample;
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="gOMyZDOeQl"><RenderMd content={`\`\`\`Go
package main
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Python" key="eD2NS3ndEX"><RenderMd content={`\`\`\`Python
import os
import time
# Install SDK:  pip install 'volcengine-python-sdk[ark]'
from volcenginesdkarkruntime import Ark 
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="ICSlQyiubN"><RenderMd content={`\`\`\`Java
package com.ark.sample;
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="aPma5BVJ2n"><RenderMd content={`\`\`\`Go
package main
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Python" key="rHVq9JP7qi"><RenderMd content={`\`\`\`Python
import os
import time  
# Install SDK:  pip install 'volcengine-python-sdk[ark]'
from volcenginesdkarkruntime import Ark 
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="EpPluzhqGg"><RenderMd content={`\`\`\`Java
package com.ark.sample;
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="x3ide8YWM8"><RenderMd content={`\`\`\`Go
package main
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Python" key="JkBnL6d2vv"><RenderMd content={`\`\`\`Python
import os
import time
# Install SDK:  pip install 'volcengine-python-sdk[ark]'
from volcenginesdkarkruntime import Ark 
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="cEUIdWqQfv"><RenderMd content={`\`\`\`Java
package com.ark.sample;
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="Gbh7h7WzpK"><RenderMd content={`\`\`\`Go
package main
...
:::tip
2026年3月11日起，使用 Seedance 2.0 及 2.0 fast 模型生成的视频，支持二次创作。二次创作的有效期为30天，即近30天内生成的模型产物支持作为素材进行二次创作。
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Python" key="GcWObnBboi"><RenderMd content={`1. 首次生视频，并获取视频 URL。此处直接用[使用虚拟人像](/docs/82379/2277377#2bf01416)的例子。
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="BQrtEWPtIg"><RenderMd content={`1. 首次生视频，并获取视频 URL。此处直接用[使用虚拟人像](/docs/82379/2277377#2bf01416)的例子。
2. 对 Seedance 2.0 生成的视频进行再次编辑。视频原始 URL 的有效期仅 24 小时，本示例将原始视频转存至 TOS 使用。
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="QUT0LlA8aD"><RenderMd content={`1. 首次生视频，并获取视频 URL。此处直接用[使用虚拟人像](/docs/82379/2277377#2bf01416)的例子。
2. 对 Seedance 2.0 生成的视频进行再次编辑。视频原始 URL 的有效期仅 24 小时，本示例将原始视频转存至 TOS 使用。
