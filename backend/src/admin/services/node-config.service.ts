...
export class NodeConfigService {
  ...
  async initializeDefaultConfigs() {
    const defaultConfigs: NodeConfigDto[] = [
      ...
      // 生图节点
      { nodeKey: 'generate', nameZh: '生成节点', nameEn: 'Generate', category: 'image', sortOrder: 10, creditsPerCall: 60, serviceType: 'gemini-2.5-image', priceYuan: 0.6, description: '文生图，按次计费' },
      { nodeKey: 'generate4', nameZh: '四图生成', nameEn: 'Generate 4', category: 'image', sortOrder: 11, creditsPerCall: 240, serviceType: 'gemini-2.5-image', priceYuan: 2.4, description: '一次生成4张图' },
