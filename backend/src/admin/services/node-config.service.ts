  ...
  async initializeDefaultConfigs() {
    const defaultConfigs: NodeConfigDto[] = [
      ...
      // 生图节点
      {
        ...
        priceYuan: 0.2,
        description: '文生图，按次计费',
        metadata: buildManagedImageNodeMetadata({
          modelKeys: ['gemini-2.5-image'],
          managedModelKey: 'gemini-2.5-image',
          defaultData: { creditsPerCall: 20 },
        }),
      },
      {
        nodeKey: 'generate4',
      ...
      },
      {
        ...
        description: '高质量文生图',
        metadata: buildManagedImageNodeMetadata({
          modelKeys: ['gemini-3-pro-image'],
          managedModelKey: 'gemini-3-pro-image',
          defaultData: { creditsPerCall: 40 },
        }),
      },
      {
        nodeKey: 'generatePro4',
        nameZh: '高级四图',
        nameEn: 'Generate Pro 4',
        category: 'image',
        sortOrder: 13,
        creditsPerCall: 160,
        serviceType: 'gemini-3-pro-image',
        ...
        metadata: buildManagedImageNodeMetadata({
          modelKeys: ['gemini-3-pro-image'],
          managedModelKey: 'gemini-3-pro-image',
          defaultData: { creditsPerCall: 160 },
        }),
      },
      {
        ...
        description: '参考图生成',
        metadata: buildManagedImageNodeMetadata({
          modelKeys: ['gemini-image-blend'],
          managedModelKey: 'gemini-image-blend',
          defaultData: { creditsPerCall: 40 },
        }),
      },
      {
      ...
      },
      {
        ...
        priceYuan: 0,
        description: 'Hailuo 模型族节点；规格与价格由 new-api 动态提供',
        metadata: {
