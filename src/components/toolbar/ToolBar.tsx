...
const ToolBar: React.FC<ToolBarProps> = ({
  ...
  return (
    <div
      className="fixed left-2 top-1/2 transform -translate-y-1/2 flex flex-col items-center gap-2 px-2 py-3 rounded-lg bg-white/80 backdrop-blur-md shadow-lg border border-white/20 z-[1000] transition-all duration-300"
      style={{
      ...
      <div className="relative">
        ...
        {(drawMode === 'free' || drawMode === 'line' || drawMode === 'rect' || drawMode === 'circle') && !isEraser && (
          <div className="absolute left-full ml-3 transition-all duration-200 ease-in-out z-[1001]" style={{ top: '-10px' }}>
            <div className="flex items-center gap-3 px-3 py-2 rounded-lg bg-white/80 backdrop-blur-md shadow-lg border border-white/20" style={{ marginTop: '1px' }}>
              {/* 绘图工具按钮组 */}
