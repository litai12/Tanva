...
function ProjectPreviewGrid({
  ...
  const hasLoadedImages = Array.isArray(images) && images.length > 0;
  const sourceImages = hasLoadedImages
  ...
  const overflowCount = hasLoadedImages && images.length > MAX_PREVIEW_IMAGES
