              ...
              onClick={(event) => {
                ...
                window.dispatchEvent(new CustomEvent('flow:updateNodeData', {
                  detail: { 
                    id, 
                    patch: { 
                      resolution: currentResolution === '720p' ? '1080p' : currentResolution === '1080p' ? '540p' : '720p'
                    } 
                  }
                }));
              }}
          ...
          <div style={{ display: 'flex', gap: 6, marginBottom: 8 }}>
            <button
              ...
              onClick={() => {
                ...
                window.dispatchEvent(new CustomEvent('flow:updateNodeData', {
                  detail: { id, patch: { style: currentStyle === 'general' ? 'anime' : 'general' } }
                }));
              }}
              style={{
                flex: 1,
                padding: '6px 10px',
                borderRadius: 8,
                border: `1px solid ${(data as any).style === 'anime' ? '#2563eb' : '#e5e7eb'}`,
                background: (data as any).style === 'anime' ? '#2563eb' : '#fff',
            ...
            <button
              ...
              style={{
                ...
                padding: '6px 10px',
                borderRadius: 8,
                border: `1px solid ${(data as any).offPeak ? '#2563eb' : '#e5e7eb'}`,
                background: (data as any).offPeak ? '#2563eb' : '#fff',
        ...
        <div style={{ display: 'flex', gap: 6, marginBottom: 8 }}>
          <button
            ...
            style={{
              ...
              padding: '6px 10px',
              borderRadius: 8,
              border: `1px solid ${(data as any).camerafixed ? '#2563eb' : '#e5e7eb'}`,
              background: (data as any).camerafixed ? '#2563eb' : '#fff',
          ...
          <button
            ...
            style={{
              ...
              padding: '6px 10px',
              borderRadius: 8,
              border: `1px solid ${(data as any).watermark ? '#2563eb' : '#e5e7eb'}`,
              background: (data as any).watermark ? '#2563eb' : '#fff',
