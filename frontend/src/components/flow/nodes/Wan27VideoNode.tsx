        ...
        <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
          ...
          {data.status === "running" ? (
            <button
              ...
              title="停止并重置，可重新生成"
              style={{ ...styles.iconBtn, width: hasRunCredits ? "auto" : styles.iconBtn.width, minWidth: hasRunCredits ? 64 : styles.iconBtn.width, padding: hasRunCredits ? "0 10px" : undefined, background: "#dc2626", cursor: "pointer", fontSize: 12 }}
            >
              <span>停止</span>
            </button>
          ) : (
