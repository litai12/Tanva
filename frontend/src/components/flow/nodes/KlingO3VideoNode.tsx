...
function KlingO1VideoNode({ id, data, selected }: Props) {
  ...
  // Tencent-only 分镜/storyboard feature is dropped accordingly; legacy
  // storyboard fields on old nodes are tolerated (ignored) and never sent.
  const hasVideoInput = hasEdgeVideoInput;
