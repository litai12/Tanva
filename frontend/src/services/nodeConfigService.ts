...
function getDefaultConfigs(): NodeConfig[] {
  return [
    ...
    { nodeKey: "wan2R2V", nameZh: "Wan2参考视频", nameEn: "Wan2 R2V", category: "video", status: "normal", sortOrder: 29, creditsPerCall: 600 },
    ...
    { nodeKey: "videoToGif", nameZh: "视频转GIF", nameEn: "Video to GIF", category: "other", status: "normal", sortOrder: 33, creditsPerCall: 30, serviceType: "video-to-gif", priceYuan: 0.3 },
    ...
    { nodeKey: "storyboardSplit", nameZh: "分镜拆解", nameEn: "Storyboard", category: "other", status: "normal", sortOrder: 37, creditsPerCall: 10 },
    { nodeKey: "imageGrid", nameZh: "图片拼接", nameEn: "Grid", category: "other", status: "normal", sortOrder: 38, creditsPerCall: 0 },
    { nodeKey: "imageSplit", nameZh: "图片拆分", nameEn: "Split", category: "other", status: "normal", sortOrder: 39, creditsPerCall: 0 },
    { nodeKey: "imageCompress", nameZh: "图片压缩", nameEn: "Image Compress", category: "other", status: "normal", sortOrder: 40, creditsPerCall: 0 },
    { nodeKey: "three", nameZh: "2D转3D", nameEn: "2D to 3D", category: "other", status: "normal", sortOrder: 41, creditsPerCall: 200 },
    { nodeKey: "audioUpload", nameZh: "语音节点", nameEn: "Audio Node", category: "audio", status: "normal", sortOrder: 42, creditsPerCall: 0 },
    { nodeKey: "minimaxSpeech", nameZh: "MiniMax语音合成", nameEn: "MiniMax Speech", category: "audio", status: "normal", sortOrder: 43, creditsPerCall: 10, serviceType: "minimax-speech" },
    { nodeKey: "minimaxMusic", nameZh: "MiniMax音乐生成", nameEn: "MiniMax Music", category: "audio", status: "normal", sortOrder: 44, creditsPerCall: 30, serviceType: "minimax-music" },
  ];
}
