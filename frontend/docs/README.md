...
| 💰 定价策略 | 39-产品定价策略.md | 10分钟 |
| 🧾 展示文案 | 40-会员定价展示文案.md | 8分钟 |
| 🎨 画布系统 | 09-画布系统技术文档.md | 30分钟 |
| 🖥️ 桌面版设计 | desktop/01-桌面端三态交互与能力架构.md | Codex 式任务外壳与画布插件工具面 |
| ⚙️ Electron 实现 | desktop/02-Electron与工具面插件实现.md | 开发、插件合同、安全与打包 |
| ✅ Codex 对齐清单 | desktop/04-Codex交互对齐清单.md | 项目、会话、侧栏、工具面与验收矩阵 |
...
### 我想了解桌面版、小T、画布与插件生态
👉 `docs/desktop/01-桌面端三态交互与能力架构.md`

### 我想开发或打包 Electron 桌面版
👉 `docs/desktop/02-Electron与工具面插件实现.md`
