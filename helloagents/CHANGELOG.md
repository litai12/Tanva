...
- Flow/Performance: MiniMap now stays hidden for 80+ node graphs; smaller graphs still unmount it during canvas pan, canvas zoom, canvas object movement, and Flow node drag, then restore shortly after interaction idle.
