...
- 2026-08-31：恢复并收紧免费积分生命周期。免费用户签到积分仅在当前凌晨 3 点切换的签到业务日内有效，余额查询、个人消费、签到入账与每日 3 点任务都会清除跨日剩余；有效月卡、年卡及 VIP 白名单签到属于永久会员权益，统一写入 permanent subscription 批次，历史 VIP 签到批次同步归类，误清积分由迁移自动补回。非有效 VIP 用户的免费签到、邀请奖励、运营赠送和受邀注册免费额度等免费积分池继续在每日 2 点按策略默认衰减 50，判定从“新用户/历史是否充值”纠正为“当前是否有有效 VIP”；`gift` 统一代表免费可衰减积分，充值本金和充值赠送统一归为不可衰减的 `recharge`。邀请奖励新增 gift lot，历史无 lot 邀请流水兼容衰减且同日幂等。
