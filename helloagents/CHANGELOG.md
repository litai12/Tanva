...
- Flow/HTML PPT: exported slides now use a fixed presentation design canvas (`1280x720` or `1024x768`) scaled as a whole page, keeping text/image proportions consistent between preview and downloaded HTML.
