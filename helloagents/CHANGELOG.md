...
- Admin/Auth: upgraded the login notice popup to restricted rich text. Admins can edit font, size, color, background color, bold, italic, and underline styles; the public notice response now includes `contentHtml` alongside plain-text `content`, and the frontend sanitizes rich text before rendering.
