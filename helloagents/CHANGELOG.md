...
- 2026-08-31：恢复并收紧免费积分生命周期。所有用户的签到积分仅在当前凌晨 3 点切换的签到业务日内有效，余额查询、个人消费、签到入账与每日 3 点任务都会清除跨日剩余，历史 permanent/无 lot 签到记录同步兼容，VIP 不再把签到积分转为永久；前端对所有用户显示实际到期时间。非有效 VIP 用户的签到、邀请奖励、运营赠送和受邀注册免费额度等免费积分池继续在每日 2 点按策略默认衰减 50，判定从“新用户/历史是否充值”纠正为“当前是否有有效 VIP”；`gift` 统一代表免费可衰减积分，充值本金和充值赠送统一归为不可衰减的 `recharge`，历史误标批次同步回填。邀请奖励新增 gift lot，历史无 lot 邀请流水兼容衰减且同日幂等。
