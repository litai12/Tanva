...
- The backend new-api image provider no longer turns an omitted aspect ratio into `1:1`, so Auto can be decided by the upstream model or reference image behavior instead of being forced square.
