...
- Export uses a fixed design canvas (`1280x720` for 16:9, `1024x768` for 4:3) and scales each entire slide page to the viewport. This prevents fixed-pixel slide typography from looking too small when the downloaded HTML is opened on a larger screen.
