...
| P1 | Flow Text Chat | `TextChatNode` 支持 Skill 预设（Custom / Shot Split / Prompt Optimize / CN-EN Convert）、上游乐观 patch 读取、节点本地 Fast/Pro/Ultra；节点底部联网搜索和状态行已移除。 | `TextChatNode.tsx`、`FlowOverlay.tsx`、`types.ts` | 已 build |
