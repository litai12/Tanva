# 豆包 Seed 2.0 视频分析按时长计费

> 本方案的 Lite-only 版本已于 2026-08-04 被当前产品定价 supersede：Pro/Lite/Mini 现在统一按 Seedance 2.0 480P 真实时长计费，比例分别为 `1/3`、`1/10`、`1/20`。本目录保留原方案作为变更背景记录。
